...
/// An implementation of [R330PrinterPlatform] that uses method channels.
class MethodChannelR330Printer extends R330PrinterPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('r330_printer_plugin');
